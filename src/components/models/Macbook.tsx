...
Command: npx gltfjsx@6.5.3 src/assets/models/macbook.glb -T 
Files: src/assets/models/macbook.glb [629.72KB] > D:\PROJECT HERRY\WEB\webmacbook\macbook-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel(props: any) {
  ...
  const { selectedColor, textture } = useMacbookStore()

  const screenTexture = useVideoTexture(textture)
